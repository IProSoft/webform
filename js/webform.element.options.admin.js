...
(function ($, Drupal, once) {
  ...
  Drupal.behaviors.webformOptionsAdmin = {
    attach(context) {
      $(once('webform-options-sync', '.js-webform-options-sync', context)).each(
        function () {
