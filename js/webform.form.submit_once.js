...
(function ($, Drupal, once) {
  ...
  Drupal.behaviors.webformSubmitOnce = {
    clear() {
      const $form = $('.js-webform-submit-once');
      $form.removeData('webform-submitted');
      $form
        .find('.js-webform-wizard-pages-links :submit, .form-actions :submit')
        .removeClass('is-disabled');
      $form
        .find('.form-actions .ajax-progress.ajax-progress-throbber')
        .remove();
    },
    attach(context) {
      $(once('webform-submit-once', '.js-webform-submit-once', context)).each(
        function () {
          const $form = $(this);
          ...
          $form
            .find(
              '.js-webform-wizard-pages-links :submit, .form-actions :submit',
            )
