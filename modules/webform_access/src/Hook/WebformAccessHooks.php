...
class WebformAccessHooks
{
    ...
    public function webformHelpInfo()
    {
        $help = [];
        // Access group.
        $help['webform_access_group'] = ['group' => 'access', 'title' => t('Webform Access: Group'), 'content' => t('The <strong>Access group</strong> page lists reusable groups used to access webform source entity and users.'), 'video_id' => 'access', 'routes' => [
            // @see /admin/structure/webform/access/group/manage
            'entity.webform_access_group.collection',
        ]];
        // Access type.
        $help['webform_access_type'] = ['type' => 'access', 'title' => t('Webform Access: Type'), 'content' => t('The <strong>Access type</strong> page lists types of groups used to send email notifications to users.'), 'video_id' => 'access', 'routes' => [
     ...
     */
    #[Hook('user_delete')]
    public function userDelete(\Drupal\Core\Entity\EntityInterface $entity)
    {
     ...
     */
    #[Hook('node_delete')]
    public function nodeDelete(\Drupal\Core\Entity\EntityInterface $entity)
    {
    ...
    public function fieldConfigDelete(\Drupal\Core\Entity\EntityInterface $entity)
    {
    ...
    public function fieldStorageConfigDelete(\Drupal\Core\Entity\EntityInterface $entity)
    {
    ...
    public function fieldWidgetSingleElementFormAlter(&$element, \Drupal\Core\Form\FormStateInterface $form_state, $context)
    {
