...
class WebformBootstrapHooks {
  ...
  public function webformElementWebformTermsOfServiceAlter(array &$element, \Drupal\Core\Form\FormStateInterface $form_state, array $context) {
  ...
  public function webformElementWebformLikertAlter(array &$element, \Drupal\Core\Form\FormStateInterface $form_state, array $context) {
    $element['#pre_render'] = array_merge([
          [
            \Drupal\webform_bootstrap\WebformBootstrapRenderCallbacks::class,
