...
class WebformCardsHooks
{
    ...
    public function webformSubmissionPresave(\Drupal\webform\WebformSubmissionInterface $webform_submission)
    {
    ...
    public function formWebformEditFormAlter(array &$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function formWebformAdminConfigFormsFormAlter(array &$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function formWebformAdminConfigElementsFormAlter(array &$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
        _webform_cards_form_alter_elements($form, [
            'element' => [
    ...
    public function formWebformSettingsFormAlter(array &$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function formWebformSettingsFormFormAlter(array &$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
        $has_cards = _webform_cards_form_state_has_cards($form_state);
        if ($has_cards) {
    ...
    public function formWebformSettingsSubmissionsFormAlter(array &$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
        $has_cards = _webform_cards_form_state_has_cards($form_state);
        if ($has_cards) {
