...
class WebformDemoApplicationEvaluationHooks
{
    ...
    public function webformSubmissionInsert(\Drupal\webform\WebformSubmissionInterface $webform_submission)
    {
    ...
    public function webformSubmissionUpdate(\Drupal\webform\WebformSubmissionInterface $webform_submission)
    {
        _webform_demo_application_evaluation_calculate_evaluation_rating($webform_submission);
    }
    /**
