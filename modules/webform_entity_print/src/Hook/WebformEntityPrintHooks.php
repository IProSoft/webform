...
class WebformEntityPrintHooks
{
    ...
    public function webformSubmissionViewAlter(array &$build, \Drupal\Core\Entity\EntityInterface $entity, \Drupal\Core\Entity\Display\EntityViewDisplayInterface $display)
    {
        $route_name = \Drupal::routeMatch()->getRouteName();
