...
class WebformExampleElementPropertiesHooks
{
    ...
    public function webformElementConfigurationFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
        ...
        $form['custom_properties']['custom_data'] = ['#type' => 'textfield', '#title' => t('Custom data'), '#description' => t("The custom data value will be added to @label (@type) data-* attributes.", $t_args)];
    }
    /**
