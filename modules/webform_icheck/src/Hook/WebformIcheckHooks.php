...
class WebformIcheckHooks
{
    ...
    public function webformLibrariesInfo()
    {
        ...
        $libraries['jquery.icheck'] = [
            ...
            'homepage_url' => \Drupal\Core\Url::fromUri('http://icheck.fronteed.com/'),
            'download_url' => \Drupal\Core\Url::fromUri('https://github.com/dargullin/icheck/archive/refs/tags/1.0.2.zip'),
            'version' => '1.0.2 ',
            'optional' => FALSE,
