...
class WebformImageSelectHooks
{
    ...
    public function webformLibrariesInfo()
    {
        ...
        $libraries['jquery.image-picker'] = [
            ...
            'homepage_url' => \Drupal\Core\Url::fromUri('https://rvera.github.io/image-picker/'),
            'download_url' => \Drupal\Core\Url::fromUri('https://github.com/rvera/image-picker/archive/refs/tags/0.3.1.zip'),
            'version' => '0.3.1',
            'elements' => [
