...
class WebformImageSelectTestHooks
{
    ...
    {
        if ($dogs = \Drupal\webform_image_select\Entity\WebformImageSelectImages::load('dogs')) {
    ...
    {
        if ($id === 'animals' && ($bears = \Drupal\webform_image_select\Entity\WebformImageSelectImages::load('bears'))) {
