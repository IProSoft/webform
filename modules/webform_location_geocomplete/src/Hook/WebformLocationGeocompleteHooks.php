...
class WebformLocationGeocompleteHooks
{
    ...
    public function webformLibrariesInfo()
    {
        ...
        $libraries['jquery.geocomplete'] = [
            ...
            'homepage_url' => \Drupal\Core\Url::fromUri('http://ubilabs.github.io/geocomplete/'),
            'download_url' => \Drupal\Core\Url::fromUri('https://github.com/ubilabs/geocomplete/archive/refs/tags/1.7.0.zip'),
            'version' => '1.7.0',
            'elements' => [
