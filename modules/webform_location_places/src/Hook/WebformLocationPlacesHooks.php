...
class WebformLocationPlacesHooks
{
    ...
    public function webformLibrariesInfo()
    {
        ...
        $libraries['algolia.places'] = [
            ...
            'homepage_url' => \Drupal\Core\Url::fromUri('https://github.com/algolia/places'),
            'issues_url' => \Drupal\Core\Url::fromUri('https://github.com/algolia/places/issues'),
            ...
            'download_url' => \Drupal\Core\Url::fromUri('https://registry.npmjs.org/places.js/-/places.js-1.19.0.tgz'),
            'version' => '1.19.0',
    ...
    public function webformAdminThirdPartySettingsFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
        ...
        $form['third_party_settings']['webform_location_places']['default_algolia_places_app_id'] = ['#type' => 'textfield', '#title' => t('Algolia application id'), '#description' => t('Algolia requires users to use a valid application id and API key for more than 1,000 requests per day. By <a href="https://www.algolia.com/users/sign_up/places">signing up</a>, you can create a free Places app and access your API keys.'), '#default_value' => $default_algolia_places_app_id];
        $form['third_party_settings']['webform_location_places']['default_algolia_places_api_key'] = ['#type' => 'textfield', '#title' => t('Algolia API key'), '#default_value' => $default_algolia_places_api_key];
    }
}
