...
class WebformOptionsCustomHooks
{
    ...
    public function webformLibrariesInfo()
    {
        ...
        $libraries['svg-pan-zoom'] = [
            ...
            'homepage_url' => \Drupal\Core\Url::fromUri('https://github.com/ariutta/svg-pan-zoom'),
            'download_url' => \Drupal\Core\Url::fromUri('https://github.com/ariutta/svg-pan-zoom/archive/refs/tags/3.6.1.zip'),
            'version' => '3.6.1',
            'optional' => FALSE,
