...
class WebformOptionsCustomHooks
{
    ...
    {
        $help = [];
        $help['config_options_custom'] = ['group' => 'configuration', 'title' => t('Configuration: Custom options'), 'content' => t('The <strong>Custom options configuration</strong> page lists reusable HTML/SVG custom options elements.'), 'video_id' => 'custom_options', 'routes' => [
    ...
    {
        $libraries = [];
        $libraries['svg-pan-zoom'] = ['title' => t('SVG Pan & Zoom'), 'description' => t('Simple pan/zoom solution for SVGs in HTML.'), 'notes' => t('Svg-pan-zoom is used by custom options elements.'), 'homepage_url' => \Drupal\Core\Url::fromUri('https://github.com/ariutta/svg-pan-zoom'), 'download_url' => \Drupal\Core\Url::fromUri('https://github.com/ariutta/svg-pan-zoom/archive/refs/tags/3.6.1.zip'), 'version' => '3.6.1', 'optional' => FALSE, 'license' => 'BSD-2-Clause'];
        return $libraries;
    }
}
