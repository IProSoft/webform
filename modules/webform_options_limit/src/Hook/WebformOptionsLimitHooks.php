...
class WebformOptionsLimitHooks
{
    ...
    {
        $help = [];
        $help['webform_options_limit'] = ['group' => 'forms', 'title' => t('Options limit'), 'content' => t("The <strong>Options</strong> page displays a summary of the webform's options limits."), 'routes' => [
    ...
    {
        return ['webform_handler_options_limit_summary' => ['variables' => ['settings' => NULL, 'handler' => []]]];
    }
    /**
