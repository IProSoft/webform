...
class WebformSchemaHooks
{
    ...
    {
        $help = [];
        $help['webform_schema'] = ['group' => 'schema', 'title' => t('Webform Schema'), 'content' => t("The <strong>Schema</strong> page displays an overview of a webform's elements and specified data types, which can be used to map webform submissions to an external API."), 'routes' => [
