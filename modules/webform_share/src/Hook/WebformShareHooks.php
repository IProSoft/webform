...
class WebformShareHooks
{
    ...
    {
        $help = [];
        $help['webform_share_embed'] = ['group' => 'share', 'title' => t('Share embed'), 'content' => t("The <strong>Share embed</strong> page provides code snippets that are used to embedded a webform in any website, webpage, and application."), 'routes' => [
        ...
        $help['webform_share_preview'] = ['group' => 'share', 'title' => t('Share preview'), 'content' => t("The <strong>Share preview</strong> page allows site builders to preview an embedded webform."), 'routes' => [
        ...
        $help['webform_share_test'] = ['group' => 'share', 'title' => t('Share test'), 'content' => t("The <strong>Share test</strong> page allows site builders to test an embedded webform."), 'routes' => [
    ...
    public function menuLocalTasksAlter(&$data, $route_name, \Drupal\Core\Cache\RefinableCacheableDependencyInterface $cacheability)
    {
        ...
        $route_names = ['entity.webform.share_embed', 'entity.webform.share_preview', 'entity.webform.share_test'];
    ...
    public function theme($existing, $type, $theme, $path)
    {
        return [
            ...
            'html__webform_share' => ['render element' => 'html'],
            'page__webform_share' => ['render element' => 'page'],
            'webform_share_iframe' => ['render element' => 'element'],
            'webform_share_script' => ['render element' => 'element'],
        ];
    }
    /**
    ...
    {
        return \Drupal\webform_share\WebformShareHelper::isPage() ? ['html__webform_share'] : [];
    }
    /**
     * Implements hook_theme_suggestions_HOOK().
     */
    ...
    {
        return \Drupal\webform_share\WebformShareHelper::isPage() ? ['page__webform_share'] : [];
    }
}
