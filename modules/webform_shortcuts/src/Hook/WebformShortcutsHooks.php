...
class WebformShortcutsHooks
{
    ...
    public function webformLibrariesInfo()
    {
        ...
        $libraries['jquery.hotkeys'] = [
            ...
            'homepage_url' => \Drupal\Core\Url::fromUri('https://github.com/jeresig/jquery.hotkeys'),
            'download_url' => \Drupal\Core\Url::fromUri('https://github.com/jeresig/jquery.hotkeys/archive/refs/tags/0.2.0.zip'),
            'version' => '0.2.0',
            'license' => 'MIT',
            'optional' => FALSE,
        ];
    ...
    public function formWebformAdminConfigAdvancedFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
