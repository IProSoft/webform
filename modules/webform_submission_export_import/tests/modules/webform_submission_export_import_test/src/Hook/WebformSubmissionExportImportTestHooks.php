...
class WebformSubmissionExportImportTestHooks
{
    ...
    public function formWebformSubmissionExportImportUploadFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
        ...
        if ($webform_id === 'test_submission_export_import' && isset($form['import']['import_url'])) {
            ...
            foreach ($file_names as $file_name) {
                ...
                $file_system->copy($csv_file_path, $destination, \Drupal\Core\File\FileExists::Replace);
