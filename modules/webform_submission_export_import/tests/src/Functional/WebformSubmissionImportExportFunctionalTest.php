...
class WebformSubmissionImportExportFunctionalTest extends WebformBrowserTestBase {
  ...
  public function testSubmissionExport() {
    ...
    $file_uri = $file_url_generator->generateAbsoluteString(File::load($submissions[2]->getElementData('file'))->getFileUri());
    $files_uri = $file_url_generator->generateAbsoluteString(File::load($submissions[2]->getElementData('files')[0])->getFileUri());
