...
class WebformSubmissionLogHooks
{
    ...
    {
        $help = [];
        $help['submissions_log'] = ['group' => 'submissions', 'title' => t('Submissions: Log'), 'content' => t('The <strong>Submissions log</strong> page tracks all submission events for all webforms that have submission logging enabled. Submission logging can be enabled globally or on a per webform basis.'), 'routes' => [
            // @see /admin/structure/webform/results/log
            'entity.webform_submission.collection_log',
        ]];
        $help['submission_log'] = ['group' => 'submission', 'title' => t('Submission: Log'), 'content' => t("The <strong>Log</strong> page shows all events and transactions for a submission."), 'video_id' => 'submission', 'routes' => [
        ...
        $help['results_log'] = ['group' => 'submissions', 'title' => t('Results: Log'), 'content' => t('The <strong>Results Log</strong> lists all webform submission events for the current webform.'), 'routes' => [
            // @see /admin/structure/webform/manage/{webform}/results/log
            'entity.webform.results_log',
        ]];
        $help['webform_node_results_log'] = ['group' => 'webform_nodes', 'title' => t('Webform Node: Results: Log'), 'content' => t('The <strong>Results Log</strong> lists all webform submission events for the current webform.'), 'routes' => [
