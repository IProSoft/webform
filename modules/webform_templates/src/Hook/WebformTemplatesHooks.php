...
class WebformTemplatesHooks
{
    ...
    {
        $help = [];
        $help['webform_templates'] = ['group' => 'forms', 'title' => t('Templates'), 'content' => t('The <strong>Templates</strong> page lists reusable templates that can be duplicated and customized to create new webforms.'), 'video_id' => 'forms', 'routes' => [
