...
class WebformTogglesHooks
{
    ...
    public function webformLibrariesInfo()
    {
        ...
        $libraries['jquery.toggles'] = [
            ...
            'homepage_url' => \Drupal\Core\Url::fromUri('https://github.com/simontabor/jquery-toggles/'),
            'download_url' => \Drupal\Core\Url::fromUri('https://github.com/simontabor/jquery-toggles/archive/refs/tags/v4.0.0.zip'),
            'version' => '4.0.0',
            'elements' => [
                'webform_toggle',
                'webform_toggles',
            ...
            'optional' => FALSE,
            'deprecated' => t('The Toggles library is not being maintained and has major accessibility issues. It has been <a href=":href">deprecated</a>.', [
