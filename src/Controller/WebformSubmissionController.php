...
class WebformSubmissionController extends ControllerBase {
  ...
  public static function buildSticky(WebformSubmissionInterface $webform_submission) {
    ...
    return new FormattableMarkup('<span class="webform-icon webform-icon-sticky webform-icon-sticky--@state" title="Add star"></span><span class="visually-hidden">@label</span>', $args);
  }
  ...
  public static function buildLocked(WebformSubmissionInterface $webform_submission) {
    ...
    return new FormattableMarkup('<span class="webform-icon webform-icon-lock webform-icon-locked--@state" title="Lock submission"></span><span class="visually-hidden">@label</span>', $args);
  }
