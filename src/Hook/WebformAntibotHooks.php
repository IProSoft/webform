...
class WebformAntibotHooks
{
    ...
    public function antibotWebformAdminThirdPartySettingsFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function antibotWebformThirdPartySettingsFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
        /** @var \Drupal\webform\WebformThirdPartySettingsManagerInterface $third_party_settings_manager */
        $third_party_settings_manager = \Drupal::service('webform.third_party_settings_manager');
    ...
    public function antibotWebformSubmissionFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id)
    {
