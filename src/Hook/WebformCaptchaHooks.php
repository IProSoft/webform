...
class WebformCaptchaHooks
{
    ...
    public function captchaWebformAdminThirdPartySettingsFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
        ...
        $t_args = [':href' => \Drupal\Core\Url::fromRoute('captcha_settings')->toString(), '@from' => t('Place a CAPTCHA here for untrusted users.'), '@to' => t('Add CAPTCHA element to this webform for untrusted users.')];
    ...
    public function captchaWebformSubmissionFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id)
    {
