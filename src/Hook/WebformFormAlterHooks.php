...
class WebformFormAlterHooks
{
    ...
    public function formAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id)
    {
        switch ($form_id) {
            ...
            case 'field_config_edit_form':
                ...
                \Drupal\Component\Utility\NestedArray::unsetValue($form, [
                    'settings',
                    'allowed_formats',
                    '#options',
                    \Drupal\webform\Element\WebformHtmlEditor::DEFAULT_FILTER_FORMAT,
                ]);
                break;
        }
    ...
    public function formUpdateManagerUpdateFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function formViewsExposedFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id)
    {
    ...
    public function formSmtpAdminSettingsAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function formConfigSingleImportFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
