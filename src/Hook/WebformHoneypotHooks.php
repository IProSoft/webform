...
class WebformHoneypotHooks
{
    ...
    public function honeypotWebformAdminThirdPartySettingsFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function honeypotWebformThirdPartySettingsFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
        /** @var \Drupal\webform\WebformThirdPartySettingsManagerInterface $third_party_settings_manager */
        $third_party_settings_manager = \Drupal::service('webform.third_party_settings_manager');
    ...
    public function honeypotWebformSubmissionFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id)
    {
