...
class WebformTranslationHooks
{
    ...
    public function formLanguageContentSettingsFormAlter(array &$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function formLocaleTranslateEditFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function formConfigTranslationAddFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $is_new = TRUE)
    {
