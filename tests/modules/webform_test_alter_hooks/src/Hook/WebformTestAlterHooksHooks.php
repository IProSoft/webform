...
class WebformTestAlterHooksHooks
{
    ...
    public function formWebformSubmissionFormAlter(array $form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id)
    {
    ...
    public function formWebformSubmissionContactFormAlter(array $form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id)
    {
    ...
    public function formWebformSubmissionContactAddFormAlter(array $form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id)
    {
        \Drupal::messenger()->addStatus(t("@hook: '@form_id' executed.", [
    ...
    public function formWebformSubmissionContactNode1AddFormAlter(array $form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id)
    {
        \Drupal::messenger()->addStatus(t("@hook: '@form_id' executed.", [
            '@hook' => 'hook_form_webform_submission_FORM_ID_form_alter()',
            '@form_id' => $form_id,
    ...
    public function webformElementEmailAlter(array &$element, \Drupal\Core\Form\FormStateInterface $form_state, array $context)
    {
        \Drupal::messenger()->addStatus(t("@hook: '@webform_key' executed.", [
