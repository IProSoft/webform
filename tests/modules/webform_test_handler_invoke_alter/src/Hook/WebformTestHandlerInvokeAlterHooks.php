...
class WebformTestHandlerInvokeAlterHooks
{
    ...
    public function webformHandlerInvokeAlter(\Drupal\webform\Plugin\WebformHandlerInterface $handler, $method_name, array $args)
    {
        $t_args = [
    ...
    public function webformHandlerInvokePreCreateAlter(\Drupal\webform\Plugin\WebformHandlerInterface $handler, array $args)
    {
        $t_args = [
            '@webform_id' => $handler->getWebform()->id(),
            '@handler_id' => $handler->getHandlerId(),
