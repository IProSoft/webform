...
class WebformElementCheckboxesTest extends WebformElementBrowserTestBase {
  ...
  public function testCheckboxes() {
    ...
    $assert_session->responseContains('<div data-custom="custom wrapper data" style="border: red 1px solid" class="one-custom-wrapper-class js-form-item form-item form-type-checkbox js-form-type-checkbox form-item-checkboxes-options-properties-two js-form-item-checkboxes-options-properties-two">');
