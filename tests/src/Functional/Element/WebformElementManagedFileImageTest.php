...
class WebformElementManagedFileImageTest extends WebformElementManagedFileTestBase {
  ...
  public function testImageFileUpload() {
    ...
    $assert_session->responseContains('The image was resized to fit within the maximum allowed dimensions of <em class="placeholder">20x20</em> pixels.');
    ...
    $assert_session->responseContains("/system/files/styles/thumbnail/private/webform/test_element_image_file_attach/$sid/webform_image_file_attachment.gif");
  }
