...
webform_codemirror:
  ...
  default_key: ''
  category: 'Advanced elements'
  description: 'Provides a form element for editing code in a number of programming languages and markup. Code editing support is provided by the CodeMirror library (https://codemirror.net).'
  hidden: false
  multiline: true
  composite: false
  states_wrapper: false
...
webform_rating:
  ...
  default_key: ''
  category: 'Advanced elements'
  description: 'Provides a form element to rate something using an attractive voting widget. Rating widget is provided by the RateIt library (https://github.com/gjunge/rateit.js).'
  hidden: false
  multiline: false
  composite: false
  states_wrapper: false
...
webform_signature:
  ...
  default_key: ''
  category: 'Advanced elements'
  description: 'Provides a form element to collect electronic signatures from users. Signature support is provided by the Signature Pad library (https://github.com/szimek/signature_pad)'
  hidden: false
  multiline: false
  composite: false
  states_wrapper: false
