...
class WebformElementTableTest extends WebformElementBrowserTestBase {
  ...
  public function testTable() {
    ...
    $assert_session->responseContains('<table data-drupal-selector="edit-table-advanced" class="webform-table sticky-header responsive-enabled" id="edit-table-advanced" data-striping="1">');
...
table_advanced_04_textfield: ''");
    ...
    $assert_session->responseMatches('<div class="webform-element webform-element-type-webform-table js-form-item form-item form-type-item js-form-type-item form-item-table-states js-form-item-table-states" id="test_element_table--table_states">');
