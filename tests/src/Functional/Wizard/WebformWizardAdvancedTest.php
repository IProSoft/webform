...
class WebformWizardAdvancedTest extends WebformWizardTestBase {
  ...
  public function testAdvancedWizard() {
    ...
    $assert_session->responseMatches('#<li data-webform-page="information" class="webform-progress-bar__page webform-progress-bar__page--done">\s*<b class="webform-progress-bar__page-title">Your Information</b><span></span>\s*</li>#');
    $assert_session->responseMatches('#<li data-webform-page="contact" class="webform-progress-bar__page webform-progress-bar__page--current">\s*<b class="webform-progress-bar__page-title">Contact Information</b>\s*</li>#');
    // Check progress pages.
    ...
    $assert_session->responseMatches('#<li data-webform-page="information" class="webform-progress-bar__page webform-progress-bar__page--current">\s*<b class="webform-progress-bar__page-title">Your Information</b><span></span>\s*</li>#');
    // Check nosave class.
