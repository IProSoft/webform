...
abstract class WebformWizardTestBase extends WebformBrowserTestBase {
  ...
  protected function assertCurrentPage($title, $page): void {
    $this->assertSession()->responseMatches('|<li data-webform-page="' . $page . '" class="webform-progress-bar__page webform-progress-bar__page--current">\s*<b class="webform-progress-bar__page-title">' . $title . '</b>|');
  }
